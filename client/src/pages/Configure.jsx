...
>>>>>>> f2aa0d2e297eb80274c31a6f3044e877e939dab5
  ...
  const numericForm = {
    width: Math.min(300, Math.max(20, Number(form.width) || 100)),
    depth: Math.min(300, Math.max(20, Number(form.depth) || 100)),
    height: Math.min(30, Math.max(1, Number(form.height) || 8))
  };

  const materialFactor = materials.find(m => m[0] === form.material)?.[2] || 1;
  const estimate = useMemo(() => Math.max(299, Math.round(
